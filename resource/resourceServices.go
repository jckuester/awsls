...
var ResourceServices = map[string]string{
	...
	"aws_alb_listener":                                        "elasticloadbalancingv2",
	"aws_alb_listener_certificate":                            "elasticloadbalancingv2",
	"aws_alb_listener_rule":                                   "elasticloadbalancingv2",
	"aws_alb_target_group":                                    "elasticloadbalancingv2",
	"aws_alb_target_group_attachment":                         "elasticloadbalancingv2",
	"aws_ami":                                                 "ec2",
	"aws_ami_copy":                                            "ec2",
	...
	"aws_app_cookie_stickiness_policy":                        "elasticloadbalancing",
	...
	"aws_elb_attachment":                                      "elasticloadbalancing",
	"aws_emr_cluster":                                         "emr",
	...
	"aws_lb_cookie_stickiness_policy":                         "elasticloadbalancing",
	"aws_lb_listener":                                         "elasticloadbalancingv2",
	"aws_lb_listener_certificate":                             "elasticloadbalancingv2",
	"aws_lb_listener_rule":                                    "elasticloadbalancingv2",
	"aws_lb_ssl_negotiation_policy":                           "elasticloadbalancing",
	"aws_lb_target_group":                                     "elasticloadbalancingv2",
	"aws_lb_target_group_attachment":                          "elasticloadbalancingv2",
	...
	"aws_load_balancer_backend_server_policy":                 "elasticloadbalancing",
	"aws_load_balancer_listener_policy":                       "elasticloadbalancing",
	"aws_load_balancer_policy":                                "elasticloadbalancing",
	...
	"aws_proxy_protocol_policy":                               "elasticloadbalancing",
